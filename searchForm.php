            ...
            <div class="col-lg-8 ">
                <div class="blue_bg p-3 m-2">
                    ...
                    <form method="GET" class="searchForm" id="searchForm">
                        <input type="text" placeholder="Search by name..." name="search_word">
                        <button type="submit"><i class='bx bx-search-alt'></i></button>
                    </form>
                    <button class="sorting_btn" >Sorting in <strong><span>Ascending order <i class='bx bx-sort-a-z'></i></span></strong></button>
                    </div>
